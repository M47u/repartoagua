...
<div class="max-w-4xl mx-auto">
    <x-card>
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-slate-900">Registrar Nuevo Vehículo</h2>
            <p class="text-slate-600 mt-1">Complete los datos del vehículo para agregarlo a la flota</p>
        </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input type="text" id="placa" name="placa" :value="old('placa')" required placeholder="Ej: ABC-123" />
                        ...
                        <div>
                            ...
                            <select name="tipo" id="tipo" class="w-full rounded-lg border-slate-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                                ...
                                <option value="furgoneta" {{ old('tipo') === 'furgoneta' ? 'selected' : '' }}>🚙 Furgoneta</option>
                        ...
                        <div>
                            ...
                            <x-text-input type="text" id="marca" name="marca" :value="old('marca')" required placeholder="Ej: Toyota" />
                            <x-input-error :messages="$errors->get('marca')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="modelo" value="Modelo *" />
                            <x-text-input type="text" id="modelo" name="modelo" :value="old('modelo')" required placeholder="Ej: Hilux" />
                            <x-input-error :messages="$errors->get('modelo')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="año" value="Año *" />
                            <x-text-input type="number" id="año" name="año" :value="old('año', date('Y'))" required min="1900" :max="date('Y') + 1" />
                            <x-input-error :messages="$errors->get('año')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="color" value="Color" />
                            <x-text-input type="text" id="color" name="color" :value="old('color')" placeholder="Ej: Blanco" />
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input type="text" id="numero_motor" name="numero_motor" :value="old('numero_motor')" />
                            <x-input-error :messages="$errors->get('numero_motor')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="numero_chasis" value="Número de Chasis" />
                            <x-text-input type="text" id="numero_chasis" name="numero_chasis" :value="old('numero_chasis')" />
                            <x-input-error :messages="$errors->get('numero_chasis')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="capacidad_carga" value="Capacidad de Carga (kg)" />
                            <x-text-input type="number" id="capacidad_carga" name="capacidad_carga" :value="old('capacidad_carga')" step="0.01" />
                        ...
                        <div>
                            ...
                            <x-text-input type="number" id="capacidad_bidones" name="capacidad_bidones" :value="old('capacidad_bidones')" />
                        ...
                        <div>
                            ...
                            <x-text-input type="number" id="kilometraje" name="kilometraje" :value="old('kilometraje', 0)" required />
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <x-text-input type="date" id="ultimo_mantenimiento" name="ultimo_mantenimiento" :value="old('ultimo_mantenimiento')" />
                        ...
                        <div>
                            ...
                            <x-text-input type="date" id="proximo_mantenimiento" name="proximo_mantenimiento" :value="old('proximo_mantenimiento')" />
                        ...
                        <div>
                            ...
                            <x-text-input type="date" id="seguro_vencimiento" name="seguro_vencimiento" :value="old('seguro_vencimiento')" />
                            <x-input-error :messages="$errors->get('seguro_vencimiento')" class="mt-2" />
                        </div>

                        <div>
                            <x-input-label for="revision_tecnica" value="Revisión Técnica" />
                            <x-text-input type="date" id="revision_tecnica" name="revision_tecnica" :value="old('revision_tecnica')" />
                ...
                <div>
                    ...
                    <div class="bg-slate-50 p-4 rounded-lg">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <label class="flex items-start gap-3 p-3 bg-white rounded-lg border border-slate-200 hover:border-indigo-300 cursor-pointer transition-colors">
                                <input 
                                    type="checkbox" 
                                    name="choferes[]" 
                                    value="{{ $chofer->id }}"
                                    {{ in_array($chofer->id, old('choferes', [])) ? 'checked' : '' }}
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-xs text-amber-600 mt-1">Ya tiene {{ $chofer->vehiculosActivos->count() }} vehículo(s) asignado(s)</div>
                                    @endif
                                </div>
                            </label>
                            @endforeach
