...
@section('breadcrumbs')
    ...
    <span class="text-slate-600">Nuevo Usuario</span>
@endsection
...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-slate-500 mt-1">Registra un nuevo usuario en el sistema</p>
        </div>
    </div>
            ...
            <div class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <label class="flex items-center gap-3 p-3 bg-white border border-slate-200 rounded-lg hover:border-indigo-300 cursor-pointer transition-colors">
                                <input type="checkbox" 
                                       name="vehiculos[]" 
                                       value="{{ $vehiculo->id }}"
                                       {{ in_array($vehiculo->id, old('vehiculos', [])) ? 'checked' : '' }}
                                       class="w-4 h-4 text-indigo-600 border-slate-300 rounded focus:ring-indigo-500">
                                <div class="flex-1">
                ...
                <div>
                    ...
                    <textarea id="observaciones" 
                              name="observaciones" 
                              rows="3" 
                              class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent @error('observaciones') border-red-500 @enderror">{{ old('observaciones') }}</textarea>
                    @error('observaciones')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
